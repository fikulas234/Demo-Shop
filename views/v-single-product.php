        ...
        <div class="row justify-content-center single-pr">
            ...
            <div class="navigation-container col-8 text-center">
                <div class="btn-nav-container col-12  d-flex justify-content-between">
                    <a class="btn btn-nav" href="./single-product-page.php?stranica=<?php echo htmlspecialchars($prev['id']); ?>">PREV</a>
                    <a class="btn btn-nav" href="./single-product-page.php?stranica=<?php echo htmlspecialchars($next['id']); ?>">NEXT</a>
                </div>
                <form class="col-12" action="checkout-page-controler.php" method="get">
